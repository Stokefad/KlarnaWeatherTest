...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "WeatherMain",
            dependencies: ["UIComponentsLibrary", "WeatherDataProvider", "TemperatureUnitPickedService", "SharedModels"]),
        .target(
            name: "WeatherSearch",
            dependencies: ["UIComponentsLibrary", "GeocoderDataProvider", "SharedModels"]),
        .target(
